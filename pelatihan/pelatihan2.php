...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <?php $card = mysqli_query($conn, "SELECT * FROM tables LIMIT 19, 9");
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
            <li class="page-item">
                <a class="page-link" href="pelatihan1.php" tabindex="-1" aria-disabled="true">Sebelumnya</a>
            </li>
            ...
            <li class="page-item">
                <a class="page-link" href="pelatihan3.php">Next</a>
            </li>
        </ul>
    </nav>
