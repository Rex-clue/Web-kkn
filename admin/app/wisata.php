                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <!-- <a href="index.php?page=edit-wisata&& id=<?php echo $user['id'] ?>" class="btn btn-sm btn-success">Edit</a> -->
                    </td>
                  </tr>
                  <?php } } ?>
                  </tbody>
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Wisata</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form method="post" action="add/tambah_wisata.php" enctype="multipart/form-data">
            <div class="card-body">
  ...
  function hapus_data(data_id){
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location=("delete/hapus_wisata.php?id="+data_id);
      } 
    })
  }
</script>
