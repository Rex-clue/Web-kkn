                            ...
                            <div class="card-header border-bottom">
                                <div class="media">
                                    <div class="media-body">
                                        <h5>Lembaga Pemberdayaan Masyarakat Desa</h5>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="mb-0 content-color-secondary">
                                    <div class="card-text content-color-primary">
                                        <p>Lembaga Pemberdayaan Kemasyarakatan Desa (LPMD) adalah salah satu lembaga kemasyaratan yang
                                            berada di desa.</p>
                                        <p>TUGAS LPMD</p>
                                        <ol>
                                        ...
                                        <p align="center"><strong>DAFTAR NAMA PENGURUS LEMBAGA KEMASYARAKATAN DESA</strong></p>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-bordered">
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                $no = 1;
                                                                $lembaga = mysqli_query($koneksi, "SELECT * FROM lkmd");
