                        ...
                        <div class="card-body">
                            <div class="mb-0 content-color-secondary">
                                <div class="card-text content-color-primary">
                                    ...
                                    <p align="left"><strong> FUNGSI RT/RW</strong> </p>
                                    <ol>
                                        <li>Membuat data penduduk akan pengamatan tertentu yang diperlukan sebagai arsip desa atau kelurahan</li>
                                    ...
                                    <p align="center"><strong>DAFTAR NAMA PENGURUS RT/RW </strong></p>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $no = 1;
                                                            $rt = mysqli_query($koneksi, "SELECT * FROM rtrw ORDER BY id ASC");
