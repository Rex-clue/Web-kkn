                        ...
                        <div class="card-header border-bottom">
                            <div class="media">
                                <div class="media-body">
                                    <h5><strong>PEMBERDAYAAN KESEJAHTERAAN KELUARGA (PKK)</strong></h5>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="mb-0 content-color-secondary">
                                <div class="card-text content-color-primary">
                                    <p class="text-justify">Pemberdayaan Kesejahteraan Keluarga atau dapat disingkat dengan PKK ialah sebuah gerakan nasional dalam
                                        pembangunan masyarakat yang tumbuh dari bawah, yang pengelolaannya dari, oleh, dan untuk masyarakat. Gerakan lembaga PKK ini
                                        dapat mampu untuk membuat keluarga hidup dalam kesejahteraan, maju, dan mandiri. Adapun lembaga PKK bertujuan untuk meningkatkan
                                        kesejahteraan yang didasarkan dengan terwujudnya keluarga yang beriman dan bertakwa kepada Tuhan Yang Maha Esa, serta berakhlak
                                        mulia dan berbudi luhur, sehat sejahtera, dan maju serta mandiri.</p>

                                    <p align="left"><strong> TUGAS PKK</strong></p>
                                    <p class="text-justify">Berdasarkan Peraturan Daerah Kota Semarang Nomor 4 Tahun 2009 tentang Pembentukan Lembaga Kemasyarakatan
                                    ...
                                    <p align="left"><strong>FUNGSI PKK</strong></p>
                                    <ol>
                            ...
                            <p align="center"><strong>STRUKTUR PENGURUS PKK DESA GUNUNGSARI</strong></p>
                            <div class="image-container">
                                <img src="../img/pkk.png" alt="Gambar Anda">
                            </div>
                            <br><br><br> 
                                    
                                    <p align="center"><strong>DAFTAR NAMA PENGURUS PKK </strong></p>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $no = 1;
                                                            $rt = mysqli_query($koneksi, "SELECT * FROM pkk ORDER BY id ASC");
