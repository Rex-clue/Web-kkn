                        ...
                        <div class="card-header border-bottom">
                            <div class="media">
                                <div class="media-body">
                                    <h5><strong>Karang Taruna</strong></h5>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="mb-0 content-color-secondary">
                                <div class="card-text content-color-primary">
                                    <p align="left" class="text-justify">Karang taruna ialah suatu organisasi yang berada pada bidang sosial 
                                        kemasyarakatan yang dijadikan sebagai wadah serta sarana untuk pengembangan setiap 
                                        anggota masyarakat. Prioritas pada lembaga Karang Taruna Desa Gunungsari yaitu melaksanakan 
                                        kegiatan yang ada, dikarenakan untuk mengayomi masyarakat yang mana karang taruna sendiri 
                                        berperan dalam segala kegiatan di setiap lini masyarakat. Karang Taruna di Gunungsari sendiri 
                                        bernama “Abhipraya”. Selain itu, di beberapa dusun juga terdapat karang taruna sendiri, seperti 
                                        Karang Taruna Akabra di Dusun Brau dan Karang Taruna Persija di Dusun Jantur.
                                    </p>
                                    <p align="left"><strong>FUNGSI KARANG TARUNA</strong></p>
                                    <ol>
                                    ...
                                    <p align="left"><strong>KELOMPOK INFORMASI MASYARAKAT (KIM)</strong></p>
                                    <p align="left" class="text-justify">Kelompok Informasi Masyarakat (KIM) adalah sebuah konsep yang digunakan 
                                        dalam bidang komunikasi dan pengembangan masyarakat. KIM mengacu pada kelompok atau tim yang bertanggung 
                                        jawab untuk mengumpulkan, mengolah, dan menyebarkan informasi kepada masyarakat dalam suatu wilayah atau 
                                        komunitas tertentu. Tujuan utama KIM adalah untuk memfasilitasi aliran informasi yang efektif antara pemerintah, 
                                        lembaga, dan masyarakat. Kelompok ini berperan penting dalam membantu masyarakat memperoleh akses terhadap 
                                        informasi yang relevan, akurat, dan berguna dalam rangka mendukung pembangunan masyarakat yang berkelanjutan.
                                    </p>
