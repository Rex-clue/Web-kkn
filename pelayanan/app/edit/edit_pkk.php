<?php 
$id     = $_GET['id'];
$query  = mysqli_query($koneksi,"SELECT * FROM pkk WHERE id='$id'");
    ...
    <div class="container-fluid">
        <div class="card card-warning">
            <div class="modal-header">
              <h4 class="modal-title">Edit PKK</h4>
              <!-- <button type="button" class="close" data-dismiss="modal" aria-label="Close"> -->
                <!-- <span aria-hidden="true">&times;</span> -->
              </button>
            </div>
            <form method="post" action="update/update_pkk.php" enctype="multipart/form-data">
            <div class="card-body">
