            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">DATA TABEL FORUM ANAK DESA GUNUNGSARI</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                $no = 0;
                                $query = mysqli_query($koneksi, "SELECT * FROM forum_anak");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="index.php?page=edit-forum_anak&& id=<?php echo $user['id'] ?>" class="btn btn-sm btn-success">Edit</a> 
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
...
<div class="modal fade" id="modal-lg">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="get" action="add/tambah_forum_anak.php">
                <div class="card-body">
    ...
    function hapus_data(data_id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location = ("delete/hapus_forum_anak.php?id=" + data_id);
            }
        })
    }
</script>