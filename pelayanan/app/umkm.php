                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <!-- <a href="index.php?page=edit-umkm&& id=<?php echo $user['id'] ?>" class="btn btn-sm btn-success">Edit</a> -->
                    </td>
                  </tr>
                  <?php } } ?>
                  </tbody>
    ...
    <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form method="post" action="add/tambah_umkm.php" enctype="multipart/form-data">
            <div class="card-body">
  ...
  function hapus_data(data_id){
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location=("delete/hapus_umkm.php?id="+data_id);
      } 
    })
  }
</script>
